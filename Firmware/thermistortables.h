...
//Pt1000 with 4k7 pullup, configured as a whetstone bridge with a 640R as a reference across the TEMP1 port
#if (THERMISTORHEATER_0 == 1048)
...
#endif // THERMISTORHEATER_0 == 1048

// NT104GT-2 thermistor with 4k7 pullup, configured as a whetstone bridge with a 640R as a reference across the TEMP1 port
#if (THERMISTORHEATER_0 == 111)
...
{856 * OVERSAMPLENR,  900},
{910 * OVERSAMPLENR, 1000},
{511 * OVERSAMPLENR, 1100},
};
#endif // THERMISTORHEATER_0 == 111
